...
public class final_programm extends JFrame implements WindowListener,ActionListener {
        ...
        public final_programm() {
        	   ...
        	   ////         KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), "Cancel"); //$NON-NLS-1$
        		...
        		//
        		//Panel.setDefaultCloseOperation(JFrame.);  
               ...
               exit.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(
                	   KeyStroke.getKeyStroke(KeyEvent.VK_ESCAPE, 0), "Cancel"); //$NON-NLS-1$
                	       exit.getActionMap().put("Cancel", new AbstractAction() {//$NON-NLS-1$
                	        		public void actionPerformed(ActionEvent e){
                		System.exit(0);
                	 }  
                }); 
               ...
               confirm.getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(
                        KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "Cancel"); //$NON-NLS-1$
                           confirm.getActionMap().put("Cancel", new AbstractAction() {//$NON-NLS-1$
                            	     public void actionPerformed(ActionEvent e){
